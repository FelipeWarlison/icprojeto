    ...
    <?php
      include_once("templates\header.adm.php");
    ...
    <div class="container">
      ...
      <div class="jumbotron dasboard-panel">
        <div class="btn-group">
          <a href="questionario.adm.php?paciente=<?php echo $paciente;?>" type="button" class="btn btn-outline-success my-2 my-sm-0"><i class="fa fa-sticky-note" aria-hidden="true"></i> Adicionar questionário</a>
        ...
        <div class="dashboard-table">
          <table class="table table-hover table-striped table-responsive-sm">
            ...
            <tr>
              ...
              <td>
                <div class="btn-group">
                  <a href="edit.adm.php?Idq=<?php echo $linha['questId'];?>&pid=<?php echo $pid;?>" type="button" class="btn btn-outline-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</a>
                  <a onclick = "return confirm('Tem certeza que deseja excluir?')" href="includes\deletequestionario.adm.php?questId=<?php echo $linha['questId']?>&pid=<?php echo $linha['pid']?>" type="button" class="btn btn-outline-danger" ><i class="fa fa-trash-o" ></i> Apagar</a>
        ...
        <div class="modal fade" id="modalDeleteSite" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <form class="form-group" action="includes\deletepaciente.adm.php?paciente=<?php echo $paciente?>" method="post">
                <div class="modal-body">
