  ...
  if (isset($_POST["delete-pessoas-submit"]) && isset($_GET['paciente'])) {
    ...
    $paciente = $_GET['paciente'];
          ...
          if(!mysqli_stmt_prepare($stmt,$sql)){
            header("Location: ../registrosPesquisador.php?paciente=$paciente&#error=sqlerror");
            exit();
          } else {
            ...
            if(!mysqli_stmt_prepare($stmt1,$sql1)){
              ...
              header("Location: ../dashboardAreaPesquisador.php?#delete=successo");
              exit();
          }
        }

  } else {
    header("Location: ../dashboardAreaPesquisador.php?paciente=$paciente");
    exit();
  }
